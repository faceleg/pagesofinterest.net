...
Leadership comes from more than one source: direction, mentorship and coaching. Assuming these threads must come from one person limits individual and organisational growth. Instead if we analyse the components of leadership, we can identify more appropriate ways to receive it.
...
Having this clear split between direction of work, mentorship and coaching avoids awkward or stagnating situations that can occur when we percieve one person as taking all three of these roles. It avoids situations like:
...
Don't let yourself fall into a career-rut: think about who provides your threads of leadership. If something is missing, identify the right person in your network or organisation to fill the gap.
